...
CONFIG_FILE="${SCRIPT_DIR}/config/local-simple-bpp.yaml"
SAMPLE_CONFIG_FILE="${REPO_ROOT}/common/sample-configs/local-simple-bpp-sample.yaml"
...
echo "Welcome to BPP/PN configuration!"
...
if [[ -f "$CONFIG_FILE" ]]; then
  ...
  case "$CONFIRM_LOWER" in
    yes|y)
      ...
      backup_file="${backup_directory}/local-simple-bpp.yaml"
